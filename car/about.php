    ...
    <section class="about-info py-5 px-lg-5">
        <div class="content-w3ls-inn px-lg-5">
            <div class="container py-md-5 py-3">
                <div class="px-lg-5">
                    <h3 class="tittle-w3ls mb-lg-5 mb-4"><span class="pink">Contact Us</span> </h3>
                    <p class="mt-5 pr-lg-5">Whether you're an individual looking to sell your car, an organisation interested in talking about offloading a fleet of vehicles or would just like to find out more about what we do and how we could work together, get in touch using the details below..</p>


                    <div class="contact-hny-form mt-lg-5 mt-3">
                        <h3 class="title-hny mb-lg-5 mb-3">
                            Address</h3>
                        <p><span class="fa fa-map-marker"> </span> Kottayam Collectorate,
                            Kottyam.<span>Kerala,India</span></p>
                        <h3 class="title-hny mb-lg-5 mb-3">
                            Mobile</h3>
                        <p class="phone"><span class="fa fa-phone"></span> +91 9696 900 900 </p>
                    ...
                    <div class="map-w3pvt mt-5">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3934.059002278614!2d76.53141571461475!3d9.590182782587828!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x15dc5c664b28c78c!2sKOTTAYAM%20District%20Collectorate%20Office!5e0!3m2!1sen!2sin!4v1640748003323!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
        </div>
