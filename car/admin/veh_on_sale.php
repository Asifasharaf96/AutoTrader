            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-title mb-2">Vehicle's On Sale</p>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $r2['adtitle']; ?></td>
                                                        <td><?php echo $r2['brand']; ?></td>
                                                        <td><?php echo $r2['year']; ?></td>
                                                        <td><?php echo $r2['fuel']; ?></td>
                                                        <td><?php echo $r2['transmission']; ?></td>
                                                        <td><?php echo $r2['kmdriven']; ?></td>
                                                        <td class="font-weight-bold"><?php echo $r2['price']; ?></td>
