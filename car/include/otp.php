                ...
                <div class="container-login100">
                    <div class="wrap-login100">
                        <form action="userdataController.php" method="post" name="reg" class="login100-form validate-form">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Enter Your Verification Code">
                                <span class="btn-show-pass">
                                    <i class="zmdi zmdi-eye"></i>
                                </span>
                                <input class="input100" type="text" name="code" required>

                                <span class="focus-input100" data-placeholder="Enter Your Verification Code"></span>
                            </div>
                            ...
                            <div class="container-login100-form-btn">
                                <div class="wrap-login100-form-btn">
                                    ...
                                    <button name="vbtn" class="login100-form-btn">
                                        SUBMIT
                                    </button>
                                </div>
                            </div>
