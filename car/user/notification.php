            ...
            <div class="scrollbar-inner">
                ...
                <div class="sidenav-header  align-items-center">
                    <a class="navbar-brand" href="user_home.php">
                        <img src="assets/img/brand/a.jpg" class="navbar-brand-img" alt="..."> </a>
                </div>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                                    ...
                                    <span class="menu-title"></i>Vehicle</span>
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-header border-0">
                                <h3 class="mb-0">Notification's</h3>
                            </div>
                            <!-- Light table -->
                            <div class="table-responsive">
                                ...
                                $sql2 = "SELECT count(*) FROM `request` where vehreq!='$username'";
                                ...
                                if ($c > 0) {
                                ?>
                                    <form action="req_action.php" method="post">
                                        <table class="table align-items-center table-flush">
                                            <thead class="thead-light">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="sort">User Requested</th>
                                            ...
                                            $sql1 = "SELECT * FROM `vehreg` where username='$username'";
                                            ...
                                            $sql = "SELECT * FROM `request` where vehreq!='$username'";
                                                ...
                                                <tbody class="list">
                                                    <tr>
                                                        ...
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <span class="name mb-0 text-sm"><?php echo $row['brand']; ?></span>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        ...
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <span class="name mb-0 text-sm"><?php echo $row['year']; ?></span>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        ...
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <span class="name mb-0 text-sm"><?php echo $row['adtitle']; ?></span>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        ...
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <span class="name mb-0 text-sm"><?php echo $row['description']; ?></span>
                                                                    <input type="hidden" name="user" value="<?php echo $row['vehreq']; ?>">
                                                        ...
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <span class="name mb-0 text-sm"><?php echo $row['price']; ?></span>
                                                                    <input type="hidden" name="username" value="<?php echo $row['vehreq']; ?>">
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <span class="name mb-0 text-sm"><?php echo $row['vehreq']; ?></span>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        ...
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <bold>
                                                                        <input style="border: none; background-color: transparent; color: #1ba63b;" type="submit" name="accept" value="Accept">
                                                                        <input style="border: none; background-color: transparent; color: red;" type="submit" name="reject" value="Reject">
                                                                    </bold>
                                                                </div>
                                                            </div>
                                                        </th>
                                            ...
                                            ?><h4 style="margin: 50px 50px;" style="color:#11469c;">No New Notification's...</h4>
                                    <?php
                                        }
                                    }
                                    ?>
