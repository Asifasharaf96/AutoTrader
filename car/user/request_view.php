                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                ...
                                if ($c > 0) {
                                ?>
                                    <form action="request_view_sql.php" method="post">
                                                                ...
                                                                <div class="media-body">
                                                                    <button style="background-color: Transparent;border:none;">
                                                                        <i class="fa fa-trash text-red">
                                                                            <input style="border: none; background-color: transparent; color: red;" type="submit" name="remove" value="REMOVE">
                                                                        </i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                ...
                                ?><h4 style="margin: 50px 50px;" style="color:#11469c;">Request's Not Found...</h4>
                            <?php
                                }
                            }
