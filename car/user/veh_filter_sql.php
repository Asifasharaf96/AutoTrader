                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                if (isset($_POST['btnbrand'])) {
                                    ...
                                    $select = "SELECT * FROM `vehreg` where username!='$username' and brand='$brand';";
                                    $res = mysqli_query($conn, $select);


                                    $query = 'select * from vehreg';
                                    $where = ' Where';
                                    $and = " username!= '$username'";
                                    if (!empty($_POST['brand'])) {
                                        $and .= " AND brand='$brand'";
                                    }
                                    if (!empty($_POST['sdate'] && $_POST['edate'])) {
                                        $and .= " AND year between '$sdate' and '$edate'";
                                    }
                                    if (!empty($_POST['kmdriven'])) {
                                        $and .= " AND kmdriven <= $km";
                                    }
                                    if (!empty($_POST['sprice'] && $_POST['price'])) {
                                        $and .= " AND price between $sprice and $eprice'";
                                    }
                                    if (!empty($_POST['fuel'])) {
                                        $and .= " AND fuel='$fuel'";
                                    }
                                    if (!empty($_POST['trans'])) {
                                        $and .= " AND transmission='$trans'";
                                    }
                                        ...
                                        <section class="projects py-5" id="gallery">
                                            <div class="container py-md-2">
                                                ...
                                                <div class="row news-grids mt-md-2 mt-2 text-center">
                                                    ...
                                                    ?>
                                                    <h4 style="margin: 50px 50px;" style="color:#11469c;">Vehicle's Not Found...</h4>
                                        <?php
                                                }
                                            }
                                        }
