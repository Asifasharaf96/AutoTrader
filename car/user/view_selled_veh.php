                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-header border-0">
                                <h3 class="mb-0">Vehicle's Sold</h3>
                            </div>
                            <!-- Light table -->
                            <div class="table-responsive">
                                ...
                                $sql7 = "SELECT count(*) FROM `selledveh` where userbuyed='$username'";
                                ...
                                ?>
                                    <form action="delveh.php" method="post">
                                        <table class="table align-items-center table-flush">
                                            ...
                                            $sql = "SELECT * FROM `selledveh` where userbuyed='$username'";
                                                ...
                                                <tbody class="list">
                                                    <tr>
                                                        ...
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <span class="name mb-0 text-sm"><?php echo $row['8']; ?></span>
