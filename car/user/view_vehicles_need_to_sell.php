                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <span class="name mb-0 text-sm"><?php echo $row['fuel']; ?></span>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        ...
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <span class="name mb-0 text-sm"><?php echo $row['transmission']; ?></span>
                                                                ...
                                                                <div class="media-body">
                                                                    <button style="background-color: Transparent;border:none;">
                                                                        <i class="fa fa-trash text-red">
                                                                            <input style="border: none; background-color: transparent; color: red;" type="submit" name="submit" value="DELETE">
                                                                        </i>
                                                                    </button>
                                                                </div>
                                                            </div>
