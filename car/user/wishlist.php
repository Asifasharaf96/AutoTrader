                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                ...
                                $sql22 = "SELECT count(*) FROM `wishlist` where username='$username'";
                                ...
                                ?>
                                    ...
                                    <form action="wishlist_del.php" method="post">
                                        <table class="table align-items-center table-flush">
                                                ...
                                                <tbody class="list">
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <input type="hidden" name="wid" value="<?php echo $row[0] ?>">
                                                        ...
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <span class="name mb-0 text-sm"><?php echo $row['kmdriven']; ?></span>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        ...
                                                        <th scope="row">
                                                            <div class="media align-items-center">
                                                                <div class="media-body">
                                                                    <span class="name mb-0 text-sm"><?php echo $row['city']; ?>,<?php echo $row['district']; ?>,<?php echo $row['state']; ?></span>
                                                                ...
                                                                <div class="media-body">
                                                                    ...
                                                                    <button style="background-color: Transparent;border:none;">
                                                                        <i class="fa fa-trash text-red">
                                                                            <input style="border: none; background-color: transparent; color: red;" type="submit" name="Delete" value="REMOVE">
                                                                        </i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                            ...
                                            ?><h4 style="margin: 50px 50px;" style="color:#11469c;">The Wishlist is Empty...</h4>
                                    <?php
                                        }
                                    }
                                    ?>
